...
export const pl: TranslationStructure = {
    ...
    team: {
        tasks: {
            boardTitle: 'Zadania',
            settingsSubtitle: 'Uruchamiaj i śledź zadania agentów w chmurze',
            ...
            goal: 'Cel',
            stages: 'Etapy',
            noStages: 'Żaden etap jeszcze nie ruszył',
            branch: 'Gałąź',
            ...
            supervisedHint: 'Zatrzymuj się na kluczowych krokach do zatwierdzenia',
            autonomous: 'Autonomiczny',
            autonomousHint: 'Wykonaj od początku do końca bez zatrzymań',
            details: 'Szczegóły',
            titleLabel: 'Tytuł',
            titlePlaceholder: 'Krótkie podsumowanie',
            repoPathPlaceholder: '/home/you/project',
            history: 'Historia',
            approvalTitle: 'Zatwierdzenie planu',
            approvalHint: 'Przejrzyj plan poniżej. W razie potrzeby edytuj, następnie zatwierdź lub odrzuć.',
            loadingPlan: 'Ładowanie planu…',
            approve: 'Zatwierdź',
            approveEdited: 'Zatwierdź ze zmianami',
            reject: 'Odrzuć',
            rejectConfirm: 'Odrzucić plan i zatrzymać zadanie?',
            baseBranch: 'Gałąź bazowa',
            goalPlaceholder: 'Opisz, co ma zrobić agent…',
            create: 'Utwórz zadanie',
            createFailed: 'Nie udało się utworzyć zadania',
            cancelTask: 'Anuluj zadanie',
            cancelConfirm: ({ title }: { title: string }) => `Anulować „${title}”?`,
            stageLabel: ({ stage }: { stage: string }) => `Etap: ${stage}`,
