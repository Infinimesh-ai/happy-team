...
export const ca: TranslationStructure = {
    ...
    team: {
        tasks: {
            boardTitle: 'Tasques',
            settingsSubtitle: 'Inicia i segueix tasques d’agents al núvol',
            newTask: 'Nova tasca',
            newTaskTitle: 'Nova tasca',
            detailTitle: 'Tasca',
            inProgress: 'En curs',
            completed: 'Completades',
            empty: 'No hi ha tasques actives',
            notFound: 'Tasca no trobada',
            overview: 'Resum',
            goal: 'Objectiu',
            stages: 'Etapes',
            noStages: 'Encara no s’ha executat cap etapa',
            branch: 'Branca',
            repoPath: 'Camí del repositori',
            round: 'Ronda',
            error: 'Error',
            viewPr: 'Veure Pull Request',
            machine: 'Màquina',
            noMachines: 'No hi ha màquines disponibles',
            template: 'Plantilla',
            mode: 'Mode',
            supervised: 'Supervisat',
            supervisedHint: 'Aturar-se per aprovació en passos clau',
            autonomous: 'Autònom',
            autonomousHint: 'Executar de principi a fi sense aturar-se',
            details: 'Detalls',
            titleLabel: 'Títol',
            ...
            approve: 'Aprova',
            approveEdited: 'Aprova amb canvis',
            reject: 'Rebutja',
            rejectConfirm: 'Vols rebutjar aquest pla i aturar la tasca?',
            baseBranch: 'Branca base',
            goalPlaceholder: 'Descriu què ha de fer l’agent…',
            create: 'Crea la tasca',
            createFailed: 'No s’ha pogut crear la tasca',
            cancelTask: 'Cancel·la la tasca',
            cancelConfirm: ({ title }: { title: string }) => `Cancel·lar «${title}»?`,
            stageLabel: ({ stage }: { stage: string }) => `Etapa: ${stage}`,
            statusPending: 'Pendent',
            statusPreparing: 'Preparant',
            statusRunning: 'En execució',
            statusWaitingApproval: 'Esperant aprovació',
        ...
        preflightTitle: 'Deployment Preflight',
        preflightSubtitle: 'Check server readiness before provisioning',
        preflightOverall: 'Overall Status',
        preflightChecks: 'Checks',
        preflightOk: 'Ready',
        preflightWarning: 'Needs Attention',
        preflightActionRequired: 'Action Required',
        preflightServerUrl: ({ url }: { url: string }) => `Server ${url}`,
        preflightCheckedAt: ({ date }: { date: string }) => `checked ${date}`,
        preflightFailedToLoad: 'Failed to load deployment preflight',
        preflightNoChecks: 'No preflight checks.',
        ...
        deleteAfterUseShort: 'delete after use',
        saveSshCredential: 'Save Credential',
        sshCredentialSavedTitle: 'Credential Saved',
        sshCredentialSavedMessage: 'SSH credential is ready to use.',
        failedToSaveSshCredential: 'Failed to save SSH credential',
        selectedCredential: 'Selected',
        useSshCredential: 'Use credential',
        agents: 'Agents',
        ...
        provisionValidationFailed: 'Select a member, enter SSH details or choose a saved credential, and select at least one agent.',
        ...
        provisionRetryStartedMessage: 'Provisioning retry has started.',
        failedToRetryProvisioning: 'Failed to retry provisioning',
        retryProvisioning: 'Retry provisioning',
        machinesTitle: 'Team Machines',
        machinesSubtitle: 'Review enrolled machines and owners',
        machines: 'Machines',
        noMachinesYet: 'No machines yet.',
        failedToLoadMachines: 'Failed to load machines',
        unknownOwner: 'Unknown owner',
        lastSeen: ({ date }: { date: string }) => `last seen ${date}`,
        auditTitle: 'Team Audit',
        auditSubtitle: 'Search authentication and admin activity',
        filter: 'Filter',
        actionFilterPlaceholder: 'Action name',
        auditEvents: 'Audit Events',
        noAuditEvents: 'No audit events.',
        failedToLoadAudit: 'Failed to load audit events',
        actor: ({ id }: { id: string }) => `actor ${id}`,
        systemActor: 'system',
        target: ({ id }: { id: string }) => `target ${id}`,
        loadMore: 'Load More',
        agentAuthTitle: 'Team Agent Access',
        agentAuthSettingsSubtitle: 'Choose company API keys or personal OAuth',
        agentAuthModeSubtitle: 'Tap to switch mode',
        companyApiMode: 'Company API',
        personalOAuthMode: 'Personal OAuth',
        failedToLoadAgentAuth: 'Failed to load agent access',
