...
export const zhHant: TranslationStructure = {
    ...
    team: {
        tasks: {
            ...
            mode: '模式',
            supervised: '監督',
            supervisedHint: '在關鍵步驟暫停以待核准',
            autonomous: '自主',
            autonomousHint: '不停頓地端到端執行',
            details: '詳情',
            titleLabel: '標題',
            ...
            approveEdited: '編輯後核准',
            reject: '退回',
            rejectConfirm: '退回此計畫並停止任務？',
            baseBranch: '基礎分支',
            goalPlaceholder: '描述代理應完成的工作……',
            create: '建立任務',
            createFailed: '無法建立任務',
            cancelTask: '取消任務',
            cancelConfirm: ({ title }: { title: string }) => `取消「${title}」？`,
            stageLabel: ({ stage }: { stage: string }) => `階段：${stage}`,
            statusPending: '待處理',
            statusPreparing: '準備中',
            statusRunning: '執行中',
