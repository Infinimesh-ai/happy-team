...
export const pt: TranslationStructure = {
    ...
    team: {
        tasks: {
            boardTitle: 'Tarefas',
            settingsSubtitle: 'Inicie e acompanhe tarefas de agentes na nuvem',
            newTask: 'Nova tarefa',
            ...
            goal: 'Objetivo',
            stages: 'Etapas',
            noStages: 'Nenhuma etapa executada ainda',
            branch: 'Branch',
            ...
            machine: 'Máquina',
            noMachines: 'Nenhuma máquina disponível',
            template: 'Modelo',
            mode: 'Modo',
            supervised: 'Supervisionado',
            supervisedHint: 'Pausar para aprovação em etapas importantes',
            autonomous: 'Autônomo',
            autonomousHint: 'Executar do início ao fim sem parar',
            details: 'Detalhes',
            titleLabel: 'Título',
            titlePlaceholder: 'Resumo breve',
            repoPathPlaceholder: '/home/you/project',
            history: 'Histórico',
            approvalTitle: 'Aprovação do plano',
            approvalHint: 'Revise o plano abaixo. Edite se necessário e depois aprove ou rejeite.',
            loadingPlan: 'Carregando plano…',
            approve: 'Aprovar',
            approveEdited: 'Aprovar com edições',
            reject: 'Rejeitar',
            rejectConfirm: 'Rejeitar este plano e parar a tarefa?',
            baseBranch: 'Branch base',
            goalPlaceholder: 'Descreva o que o agente deve fazer…',
            create: 'Criar tarefa',
            createFailed: 'Não foi possível criar a tarefa',
            cancelTask: 'Cancelar tarefa',
            cancelConfirm: ({ title }: { title: string }) => `Cancelar "${title}"?`,
