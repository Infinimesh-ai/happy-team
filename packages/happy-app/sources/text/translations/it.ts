...
export const it: TranslationStructure = {
    ...
    team: {
        tasks: {
            boardTitle: 'Attività',
            settingsSubtitle: 'Avvia e monitora le attività degli agenti cloud',
            newTask: 'Nuova attività',
            newTaskTitle: 'Nuova attività',
            detailTitle: 'Attività',
            inProgress: 'In corso',
            completed: 'Completate',
            empty: 'Nessuna attività attiva',
            notFound: 'Attività non trovata',
            overview: 'Panoramica',
            goal: 'Obiettivo',
            stages: 'Fasi',
            noStages: 'Nessuna fase ancora eseguita',
            branch: 'Ramo',
            repoPath: 'Percorso del repository',
            round: 'Round',
            error: 'Errore',
            viewPr: 'Vedi Pull Request',
            machine: 'Macchina',
            noMachines: 'Nessuna macchina disponibile',
            template: 'Modello',
            mode: 'Modalità',
            supervised: 'Supervisionata',
            supervisedHint: 'Fermati per l’approvazione nei passaggi chiave',
            autonomous: 'Autonoma',
            autonomousHint: 'Esegui dall’inizio alla fine senza fermarti',
            details: 'Dettagli',
            titleLabel: 'Titolo',
            ...
            approve: 'Approva',
            approveEdited: 'Approva con modifiche',
            reject: 'Rifiuta',
            rejectConfirm: 'Rifiutare questo piano e fermare l\'attività?',
            baseBranch: 'Ramo base',
            goalPlaceholder: 'Descrivi cosa deve fare l’agente…',
            create: 'Crea attività',
            createFailed: 'Impossibile creare l’attività',
            cancelTask: 'Annulla attività',
            cancelConfirm: ({ title }: { title: string }) => `Annullare «${title}»?`,
            stageLabel: ({ stage }: { stage: string }) => `Fase: ${stage}`,
            statusPending: 'In attesa',
            statusPreparing: 'Preparazione',
            statusRunning: 'In esecuzione',
            statusWaitingApproval: 'In attesa di approvazione',
            statusSucceeded: 'Completata',
            statusFailed: 'Fallita',
            statusEscalated: 'Escalation',
