...
export const ru: TranslationStructure = {
    ...
    team: {
        tasks: {
            boardTitle: 'Задачи',
            settingsSubtitle: 'Запуск и отслеживание облачных задач',
            ...
            goal: 'Цель',
            stages: 'Этапы',
            noStages: 'Этапы ещё не запускались',
            branch: 'Ветка',
            repoPath: 'Путь к репозиторию',
            round: 'Раунд',
            error: 'Ошибка',
            viewPr: 'Открыть Pull Request',
            machine: 'Машина',
            noMachines: 'Нет доступных машин',
            template: 'Шаблон',
            mode: 'Режим',
            supervised: 'С контролем',
            supervisedHint: 'Останавливаться для подтверждения на ключевых шагах',
            autonomous: 'Автономный',
            autonomousHint: 'Выполнять до конца без остановок',
            details: 'Детали',
            titleLabel: 'Название',
            ...
            approve: 'Утвердить',
            approveEdited: 'Утвердить с правками',
            reject: 'Отклонить',
            rejectConfirm: 'Отклонить план и остановить задачу?',
            baseBranch: 'Базовая ветка',
            goalPlaceholder: 'Опишите, что должен сделать агент…',
            create: 'Создать задачу',
            createFailed: 'Не удалось создать задачу',
            cancelTask: 'Отменить задачу',
            cancelConfirm: ({ title }: { title: string }) => `Отменить «${title}»?`,
            stageLabel: ({ stage }: { stage: string }) => `Этап: ${stage}`,
