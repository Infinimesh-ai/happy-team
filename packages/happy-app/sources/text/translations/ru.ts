...
export const ru: TranslationStructure = {
    ...
    team: {
        ...
        productTitle: 'Happy Team',
        loginSubtitle: 'Sign in with the email and password from your administrator.',
        email: 'Email',
        ...
        signOutConfirm: 'Sign out of this browser before using another Team account?',
        ...
        signInAgain: 'Sign in again before changing your password.',
        passwordsDoNotMatch: 'New passwords do not match.',
        passwordChangedTitle: 'Password Changed',
        passwordChangedMessage: 'Your Team password has been updated.',
        ...
        temporaryPassword: ({ password }: { password: string }) => `Temporary password:\n${password}`,
        ...
        provisionMachine: 'Provision Machine',
        provisionMachineSubtitle: 'Initialize a member machine over SSH',
        ...
        deleteCredentialAfterUse: 'Delete credential after use',
        agents: 'Agents',
        claudeCode: 'Claude Code',
        codex: 'Codex',
        startProvisioning: 'Start Provisioning',
        requestManualCommand: 'Manual Command',
        manualInstallCommand: 'Manual Install Command',
        copyManualCommand: 'Copy Command',
        manualCommandCopied: 'Manual install command copied to clipboard',
        failedToLoadProvisioning: 'Failed to load provisioning data',
        failedToStartProvisioning: 'Failed to start provisioning',
        failedToCreateEnrollToken: 'Failed to create enroll token',
        provisionValidationFailed: 'Select a member, host, username, secret, and at least one agent.',
        provisionStartedTitle: 'Provisioning Started',
        provisionStartedMessage: 'Provisioning job has started.',
        savedCredentials: 'Saved SSH Credentials',
        noSavedCredentials: 'No saved SSH credentials.',
        deleteCredentialTitle: 'Delete Credential',
        deleteCredentialConfirm: ({ label }: { label: string }) => `Delete ${label}?`,
        provisioningJobs: 'Provisioning Jobs',
        noProvisionJobs: 'No provisioning jobs yet.',
        provisionPending: 'Pending',
        provisionRunning: 'Running',
        provisionSucceeded: 'Succeeded',
        provisionFailed: 'Failed',
        jobSubtitle: ({ step, agents }: { step: string; agents: string }) => `Step ${step} / ${agents}`,
    },
