...
export const es: TranslationStructure = {
    ...
    team: {
        tasks: {
            boardTitle: 'Tareas',
            settingsSubtitle: 'Lanza y sigue tareas de agentes en la nube',
            newTask: 'Nueva tarea',
            ...
            goal: 'Objetivo',
            stages: 'Etapas',
            noStages: 'Aún no se ha ejecutado ninguna etapa',
            branch: 'Rama',
            ...
            supervisedHint: 'Pausar para aprobación en pasos clave',
            autonomous: 'Autónomo',
            autonomousHint: 'Ejecutar de principio a fin sin parar',
            details: 'Detalles',
            titleLabel: 'Título',
            titlePlaceholder: 'Resumen breve',
            repoPathPlaceholder: '/home/you/project',
            history: 'Historial',
            approvalTitle: 'Aprobación del plan',
            approvalHint: 'Revisa el plan de abajo. Edítalo si es necesario y luego apruébalo o recházalo.',
            loadingPlan: 'Cargando plan…',
            approve: 'Aprobar',
            approveEdited: 'Aprobar con cambios',
            reject: 'Rechazar',
            rejectConfirm: '¿Rechazar este plan y detener la tarea?',
            baseBranch: 'Rama base',
            goalPlaceholder: 'Describe qué debe hacer el agente…',
            create: 'Crear tarea',
