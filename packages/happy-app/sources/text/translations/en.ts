...
export const en: TranslationStructure = {
    ...
    team: {
        tasks: {
            boardTitle: 'Tasks',
            settingsSubtitle: 'Launch and track cloud agent tasks',
            newTask: 'New Task',
            ...
            goal: 'Goal',
            stages: 'Stages',
            noStages: 'No stages have run yet',
            branch: 'Branch',
            ...
            supervisedHint: 'Pause for approval at key steps',
            autonomous: 'Autonomous',
            autonomousHint: 'Run end to end without stopping',
            details: 'Details',
            titleLabel: 'Title',
            ...
            reject: 'Reject',
            rejectConfirm: 'Reject this plan and stop the task?',
            baseBranch: 'Base Branch',
            goalPlaceholder: 'Describe what the agent should do…',
            create: 'Create Task',
            createFailed: 'Could not create task',
            cancelTask: 'Cancel Task',
            cancelConfirm: ({ title }: { title: string }) => `Cancel “${title}”?`,
            stageLabel: ({ stage }: { stage: string }) => `Stage: ${stage}`,
