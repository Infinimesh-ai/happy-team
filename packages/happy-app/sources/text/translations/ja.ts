...
export const ja: TranslationStructure = {
    ...
    team: {
        tasks: {
            boardTitle: 'タスク',
            settingsSubtitle: 'クラウドエージェントのタスクを起動・追跡',
            newTask: '新規タスク',
            newTaskTitle: '新規タスク',
            detailTitle: 'タスク',
            inProgress: '進行中',
            completed: '完了',
            empty: 'アクティブなタスクはありません',
            notFound: 'タスクが見つかりません',
            overview: '概要',
            goal: '目標',
            stages: 'ステージ',
            noStages: 'まだ実行されたステージはありません',
            branch: 'ブランチ',
            repoPath: 'リポジトリのパス',
            round: 'ラウンド',
            error: 'エラー',
            viewPr: 'プルリクエストを表示',
            machine: 'マシン',
            noMachines: '利用可能なマシンがありません',
            template: 'テンプレート',
            mode: 'モード',
            supervised: '監視あり',
            supervisedHint: '重要なステップで承認のために停止',
            autonomous: '自律',
            autonomousHint: '停止せず最後まで実行',
            details: '詳細',
            titleLabel: 'タイトル',
            ...
            approve: '承認',
            approveEdited: '編集して承認',
            reject: '却下',
            rejectConfirm: 'この計画を却下してタスクを停止しますか？',
            baseBranch: 'ベースブランチ',
            goalPlaceholder: 'エージェントに行わせる内容を記述…',
            create: 'タスクを作成',
            createFailed: 'タスクを作成できませんでした',
            cancelTask: 'タスクをキャンセル',
            cancelConfirm: ({ title }: { title: string }) => `「${title}」をキャンセルしますか？`,
            stageLabel: ({ stage }: { stage: string }) => `ステージ: ${stage}`,
            statusPending: '保留中',
            statusPreparing: '準備中',
            statusRunning: '実行中',
