...
export const zhHans: TranslationStructure = {
    ...
    team: {
        tasks: {
            ...
            mode: '模式',
            supervised: '监督',
            supervisedHint: '在关键步骤暂停以待批准',
            autonomous: '自主',
            autonomousHint: '不停顿地端到端执行',
            details: '详情',
            titleLabel: '标题',
            ...
            approveEdited: '编辑后批准',
            reject: '打回',
            rejectConfirm: '打回该计划并停止任务？',
            baseBranch: '基础分支',
            goalPlaceholder: '描述智能体应完成的工作……',
            create: '创建任务',
            createFailed: '无法创建任务',
            cancelTask: '取消任务',
            cancelConfirm: ({ title }: { title: string }) => `取消“${title}”？`,
            stageLabel: ({ stage }: { stage: string }) => `阶段：${stage}`,
            statusPending: '待处理',
            statusPreparing: '准备中',
            statusRunning: '运行中',
